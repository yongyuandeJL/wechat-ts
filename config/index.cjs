...
{
      name: "自己",
      id: "oxMjp58rEX4mZTIeYocrbFyherQo",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "3R5vnFoKi_YqTiafolEZzZGj9Q811Quj-DOuiQb9a68",
      // 所在省份
      province: "四川",
      // 所在城市
      city: "南充",
      ...
      festivals: [
        // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
        {"type": "*生日", "name": "韩妹妹", "year": "1998", "date": "04-16"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
  ...
  CALLBACK_TEMPLATE_ID: "zpjGBL09iMBXTO9Z01bfFc4nICuDtPVZjbAm7alRW-A",
  ...
  FESTIVALS: [
    // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
    {"type": "*生日", "name": "小吴", "year": "1995", "date": "05-26", isShowAge: true},
    // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
    {"type": "生日", "name": "自己", "year": "1998", "date": "04-16", isShowAge: true},
